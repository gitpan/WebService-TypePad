package WebService::TypePad::Object::Post;
use strict;
use warnings;
...
This is a Perl representation of TypePad's Post object type.
For more information about this type and its parameters, see L<the documentation on TypePad's developer site|http://www.typepad.com/services/apidocs/objecttypes/Post>.
...
=head2 $post->embedded_image_links

A list of links to the images that are embedded within the content of this post.

Returns an array of L<ImageLink|WebService::TypePad::Object::ImageLink> objects.

=head2 $post->favorite_count
...
=head2 $post->is_favorite_for_current_user
...
=item * L<http://www.typepad.com/services/apidocs/objecttypes/Post>
