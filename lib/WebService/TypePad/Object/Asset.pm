package WebService::TypePad::Object::Asset;
use strict;
use warnings;
...
WebService::TypePad::Object::Asset - Perl representation of TypePad's Asset object type

=head1 SYNOPSIS

    use WebService::TypePad::Object::Asset;
    my $asset = WebService::TypePad::Object::Asset->new();

=head1 DESCRIPTION

This is a Perl representation of TypePad's Asset object type.
For more information about this type and its parameters, see L<the documentation on TypePad's developer site|http://www.typepad.com/services/apidocs/objecttypes/Asset>.
...
=head2 $asset->is_favorite_for_current_user
...
=item * L<WebService::TypePad::Noun::Assets>

=item * L<http://www.typepad.com/services/apidocs/objecttypes/Asset>
